...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-lg-8">
        ...
        <?php
        $iminpelanggan = ('iMinID_stock');
        ?>
        <div class="form-group">
            <label for="pelanggan">Pelanggan</label>
            <input type="text" class="form-control" id="pelanggan"
            name="pelanggan" value="{{ $iminpelanggan }}" readonly>
        </div>
        <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="perbaikan" name="perbaikan" value="-" readonly>
        </div>
        <div class="form-group">
          <label for="snkanibal">SN Kanibal</label>
          <input type="text" class="form-control" id="snkanibal" name="snkanibal" value="-" readonly>
        </div>
        <div class="form-group">
          <label for="nosparepart">No SparePart</label>
          <input type="text" class="form-control" id="nosparepart" name="nosparepart" value="-" readonly>
        </div>
        <div class="form-group">
