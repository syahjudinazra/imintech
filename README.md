## Technician Hardware Management

Web Apps Sederhana Untuk Teknisi Mengelola Hardware Service
<ul>
    ...
    <li>Menu monitor untuk memantau perbandingan data table service pending dengan sevice dong</li>
</ul>
### Tech Stack
<ul>
    <li>Laravel 8</li>
...
lain-lain:    
    <li>maatwebsites/excel</li>
    <li>Bootstrap Example Theme</li>
</ul>
### Instalasi
<ul>
